Site de ecommerce que possui página principal semi funcional, seção para visualização de produtos destacados, seção para visualização de produtos populares, seção de notícias, 
